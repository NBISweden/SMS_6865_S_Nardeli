...
# Test by using
#     sbatch --test-only Bait_bwa-mem_unpaired_R2.slurm.sh
# Start by using 
#     sbatch Bait_bwa-mem_unpaired_R2.slurm.sh
# Stop by using
#     scancel 1234
#     scancel -i -u $USER
...
#SBATCH -J Bait_bwa-mem_unpaired_R2
...
for f in *_R2_Araport.sorted.fq.gz ; do
